...
- [ ] Flutter SDK kurulumu ve yap�land�rmas� (son stable version) - Flutter 3.35.5, Dart 3.9.2
- [ ] iOS geli�tirme ortam� (Xcode, CocoaPods) - N/A (Windows ortam�, ad�m atland�)
- [ ] Android geli�tirme ortam� (Android Studio, SDK) - Android SDK 36.1.0, Android Studio 2025.1.2
- [ ] Git repository olu�turma ve branch stratejisi belirleme - Git init, main branch
...
- [ ] Repository Firebase altyap�s� haz�rland� (FirebaseInitializer, security rules, .firebaserc, CLI script)
- [ ] FlutterFire CLI kurulumu (dart pub global activate flutterfire_cli)
- [ ] Firestore & Storage Security Rules yaz�ld� (firebase/firestore.rules, firebase/storage.rules)
- [ ] Firebase projesi olu�turma (Console) - kullan�c� aksiyonu (bkz. docs/firebase-setup.md)
- [ ] iOS app ekleme ve GoogleService-Info.plist indirme - kullan�c� aksiyonu
- [ ] Android app ekleme ve google-services.json indirme - kullan�c� aksiyonu
- [ ] Firebase initialize (flutterfire configure) �al��t�rma - kullan�c� aksiyonu (konfig�rasyon dosyalar� sonras�)
- [ ] Firebase Authentication aktifle�tirme (Email/Password, Google, Apple) - kullan�c� aksiyonu
- [ ] Firestore Database olu�turma (region se�imi: europe-west1) - kullan�c� aksiyonu
- [ ] Firebase Storage bucket olu�turma - kullan�c� aksiyonu
- [ ] Firebase Analytics aktifle�tirme - kullan�c� tercihi
- [ ] Firebase Crashlytics setup - konfig�rasyon sonras�
- [ ] Firebase Performance Monitoring setup - konfig�rasyon sonras�

### 0.6 Firestore Database Schema Design
- [ ] Koleksiyon �emas� ve alan tipleri dok�mante edildi (bkz. docs/architecture/firestore-schema.md)
- [ ] Firestore indeksleri tan�mland� (bkz. firebase/firestore.indexes.json)
- [ ] Firestore g�venlik kurallar� owner fallback ile g�ncellendi (bkz. firebase/firestore.rules)
- [ ] Seed data / em�lat�r senaryolar� haz�rlanmas� (opsiyonel, Faz 1)
...
- [ ] Firebase auth wrapper service olu�turma
- [ ] Email/Password auth UI ve logic
  - Sign up form
  - Sign in form
  - Email verification
- [ ] Google Sign-In entegrasyonu (`google_sign_in` package) - provider tabanl� ak�� haz�r
  - Google Sign-In button
  - OAuth flow implementation
- [ ] Apple Sign-In entegrasyonu (iOS zorunlu - `sign_in_with_apple`) - backend haz�r
...
- [ ] Dil se�imi ekran� (TR default)
- [ ] Kullan�c� tercihleri anketi
  - Hedef kategorileri se�imi
  - G�nl�k program tercihi (sabah/ak�am ki�isi)
  - Bildirim tercihleri
- [ ] �lk habit olu�turma guided flow
- [ ] �lk task olu�turma guided flow
- [ ] Onboarding tamamlama ve dashboard'a ge�i�
- [ ] Skip option ve progress indicator

### 1.3 Localization Infrastructure (Week 4)
- [ ] i18n package setup (easy_localization / intl)
- [ ] JSON/ARB dosyalar� yap�s� olu�turma
- [ ] T�rk�e dil dosyalar� olu�turma
- [ ] Language switcher widget
- [ ] Date/time format localization
- [ ] Number format localization
- [ ] RTL support haz�rl��� (future-proof)
- [ ] Translation helper functions

### 1.4 Data Layer & Local Storage (Week 4-5)
#### Firestore Integration
- [ ] Data models olu�turma (Habit, Task, User, Category)
...
- [ ] Habit creation form
  - �sim, a��klama
  - Kategori se�imi (Health, Career, Personal, etc.)
  - Frekans se�imi (Daily, Specific Days, Weekly)
  - Renk se�imi
  - Icon se�imi
...
- Her hafta sprint review yap�lmal�
- Her 2 haftada bir kullan�c� feedback toplanmal�
- Ayl�k technical debt review
- �eyreklik roadmap review ve g�ncelleme
- Flexible olun - kullan�c� feedback'ine g�re �ncelikleri ayarlay�n
- Firebase quotas ve limits'i takip edin
- Firebase Console'dan d�zenli olarak performans metrikleri kontrol edin
